...
function EditDoc() {
    ...
    useEffect(() => {
        const fetchModule = async () => {
            try {
                const response = await axios.get(`http://localhost:6001/api/docs/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.put(`http://localhost:6001/api/docs/update/${id}`, formData, {
    ...
    return (
        <div>
            ...
            <div className="Edit-container mt-5" style={{ marginTop: "80px", padding: "50px 80px" }}>
